...
[![Build Status](https://travis-ci.org/singleplatform-eng/ansible-role-nginx.svg?branch=master)](https://travis-ci.org/singleplatform-eng/ansible-role-nginx)
...
Singleplatform has made some modifications. Including changes that render this role incompatible with Ubuntu packaged versions of Nginx.
